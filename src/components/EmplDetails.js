        ...
        <>
            <div  className="">
                <div className=" bg-indigo-500 rounded-3xl  ">
                    <div className=" absolute left-[11.5rem] top-[3rem] w-45 h-45 rounded-2xl mx-auto z-[99999] bg-[url('https://picsum.photos/200')] hover:bg-[url('https://picsum.photos/200/300')] bg-cover w-48 h-48"></div>
                </div>
                <div className="absolute top-[9rem] left-14 pt-[6rem] w-1/4 mx-auto my-3 bg-white rounded-2xl shadow-md p-5 z-1">
                    ...
                    <div className="text-center text-gray-600 mt-1">Software Engineer</div>
                    <div className="flex justify-center mt-5">
                        ...
                        <a href="https://moneyview.slack.com/team/U06L0TF17HV" target="_blank" rel="noreferrer" className="text-blue-500 hover:text-blue-700 mx-3">
                            <span className="socialbtn text-[#1C9CEA]">
                                <svg xmlns="http://www.w3.org/2000/svg" width="3.94em" height="1em" viewBox="0 0 512 130">
                                    <path d="m163.593 101.885l6.387-14.835c6.902 5.151 16.07 7.83 25.136 7.83c6.696 0 10.92-2.576 10.92-6.49c-.103-10.92-40.074-2.37-40.383-29.773c-.103-13.907 12.26-24.621 29.772-24.621c10.405 0 20.81 2.575 28.227 8.447l-5.975 15.144c-6.799-4.327-15.246-7.417-23.282-7.417c-5.46 0-9.065 2.575-9.065 5.872c.103 10.714 40.383 4.842 40.795 31.008c0 14.217-12.053 24.21-29.36 24.21c-12.672 0-24.313-2.988-33.172-9.375m245.08-20.192l17.616 9.787c-6.593 11.847-19.161 19.78-33.687 19.78c-21.325 0-38.632-17.307-38.632-38.632s17.307-38.632 38.632-38.632c14.423 0 27.094 8.035 33.687 19.78l-17.616 9.786c-3.194-5.563-9.169-9.374-16.071-9.374c-10.199 0-18.44 8.241-18.44 18.44c0 10.199 8.241 18.44 18.44 18.44c6.902 0 12.877-3.812 16.07-9.375M234.984 1.957h22.046v107.86h-22.046zm199.958 0h22.046v63.356l24.93-29.772h26.991l-30.802 35.85l33.275 38.426h-28.227L456.988 77.47v32.347h-22.046zM322.55 81.9V63.665c-3.194-5.357-9.787-9.477-17.204-9.477c-10.2 0-18.44 8.241-18.44 18.44c0 10.199 8.24 18.44 18.44 18.44c7.417 0 14.01-3.915 17.204-9.169m0-46.358h22.046v74.173H322.55v-8.756c-3.606 6.078-12.569 10.302-21.943 10.302c-19.368 0-34.614-17.307-34.614-38.735s15.246-38.529 34.614-38.529c9.374 0 18.337 4.224 21.943 10.302z">
                                    </path>
                                    <path fill="#e01e5a" d="M27.3 81.796c0 7.52-6.078 13.599-13.599 13.599A13.585 13.585 0 0 1 .103 81.796c0-7.52 6.078-13.598 13.598-13.598H27.3zm6.799 0c0-7.52 6.078-13.598 13.598-13.598c7.52 0 13.599 6.078 13.599 13.598v33.996c0 7.52-6.078 13.599-13.599 13.599A13.585 13.585 0 0 1 34.1 115.792z">
                                    </path>
                                    <path fill="#36c5f0" d="M47.697 27.197A13.585 13.585 0 0 1 34.1 13.598C34.099 6.078 40.177 0 47.697 0s13.599 6.078 13.599 13.598v13.599zm0 6.902c7.52 0 13.599 6.078 13.599 13.598c0 7.52-6.078 13.599-13.599 13.599H13.598A13.585 13.585 0 0 1 0 47.697C0 40.177 6.078 34.1 13.598 34.1z">
                                    </path>
                                    <path fill="#2eb67d" d="M102.194 47.697c0-7.52 6.078-13.598 13.598-13.598c7.52 0 13.599 6.078 13.599 13.598c0 7.52-6.078 13.599-13.599 13.599h-13.598zm-6.8 0c0 7.52-6.077 13.599-13.598 13.599a13.585 13.585 0 0 1-13.598-13.599V13.598C68.198 6.078 74.276 0 81.796 0c7.52 0 13.599 6.078 13.599 13.598z">
                                    </path>
                                    <path fill="#ecb22e" d="M81.796 102.194c7.52 0 13.599 6.078 13.599 13.598c0 7.52-6.078 13.599-13.599 13.599a13.585 13.585 0 0 1-13.598-13.599v-13.598zm0-6.8a13.585 13.585 0 0 1-13.598-13.598c0-7.52 6.078-13.598 13.598-13.598h34.1c7.52 0 13.598 6.078 13.598 13.598c0 7.52-6.078 13.599-13.599 13.599z">
                                    </path>
                                </svg>
                            </span>
                        </a>
                    ...
                    <div className="p-7 rounded-3xl mt-7 bg-[#F3F6F6] ">
                        <div className="flex py-2.5 border-b border-[#E3E3E3] ">
                            ...
                            <div className="text-left ml-2.5">
                                ...
                                <div className="">
                                    <a className="hover:text-[#FA5252] duration-300 transition" href="tel:+91 7033755056">+91 7033755056</a>
                                </div>
                            </div>
                        </div>
                        <div className="flex py-2.5 border-b border-[#E3E3E3] ">
                        ...
                        <div className="flex py-2.5 border-b border-[#E3E3E3]">
                            ...
                            <div className="text-left ml-2.5">
                                ...
                                <div className="">May 27, 1990</div>
                            </div>
                        </div>
                        <div className="flex py-2.5 border-b border-[#E3E3E3]  ">
                            <span className="p-2 rounded-md bg-white text-[#E93B81] shadow-md hover:bg-[#E93B81] hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-person-standing"><circle cx="12" cy="5" r="1" /><path d="m9 20 3-6 3 6" />
                                    <path d="m6 8 6 2 6-2" />
                                    <path d="M12 10v4" />
                                </svg>
                            </span>
                            <div className="text-left ml-2.5">
                                <div className="text-xs text-[#44566C]">Manager (ID)</div>
                                <div className="">
                                    <div className="">Jane (3144)</div>
                                </div>
                            </div>
                        </div>
                        <div className="flex py-2.5 border-b border-[#E3E3E3] ">
                            <span className="p-2 rounded-md bg-white text-[#FD7590] shadow-md hover:bg-[#E93B81] hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-users-round"><path d="M18 21a8 8 0 0 0-16 0" />
                    ...
                    <div className="flex items-center justify-center mx-auto">
                        <a href="/images/cv.pdf" download="" className="inline-flex items-center mx-auto bg-gradient-to-r from-[#fa5252] to-[#dd2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476] to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
                            <Download className="mr-2" />Download Offer Letter</a>
                    ...
                    <div className="flex items-center justify-center mx-auto">
                        <label className="inline-flex items-center mx-auto bg-gradient-to-r from-[#fa5252] to-[#dd2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476] to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
                            <svg className="w-8 h-8 pr-1 pt-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
